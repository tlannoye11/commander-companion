...
export const CARD_SCRYFALL_RESET = 'CARD_SCRYFALL_RESET';

export const CARD_SCRYFALL_EDITIONS_REQUEST = 'CARD_SCRYFALL_EDITIONS_REQUEST';
export const CARD_SCRYFALL_EDITIONS_SUCCESS = 'CARD_SCRYFALL_EDITIONS_SUCCESS';
export const CARD_SCRYFALL_EDITIONS_FAIL = 'CARD_SCRYFALL_EDITIONS_FAIL';
